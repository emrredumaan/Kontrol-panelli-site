                  ...
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        ...
                        <div class="col-md-12" align="right" >
                            <a href="slider.php"><button class=" btn btn-warning " style="width: 100px; height:50px;"> 
                            <i class="fa fa-undo" aria-hidden="true"> Geri Dön </i></button></a>
                        </div>
                  ...
                  <div class="x_content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <img width="200" height="100" src="../../<?php echo $slidercek['slider_resimyol']; ?>" alt="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="first-name" value="<?php  echo $slidercek ['slider_ad'];?>" name="slider_ad"  class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                      ...
                      <div align="right"  class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" name="sliderduzenle" class="btn btn-primary">Düzenle</button>
                      </div>
